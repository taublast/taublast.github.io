...
В следующей статье мы посмотри *как использовать SkiaCamera для распознавания лиц с помощью ML в реальном времени* и обсудим сценарии, при которых необходимо слать поток видео кадров в AI/ML.
...
К предпросмотру, снятому фото и записываемому видео мы можем применять видео фильтры на выбор. Фильтры описаны SKSL-шейдерами. я взял их из своего существующего проекта, описанного в одной из предыдущих статей на английском языке: [Камера с фотофильтрами](../FiltersCamera/).
