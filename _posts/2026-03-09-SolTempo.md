...
Recent enhancements shipped with DrawnUI [SkiaCamera](https://github.com/taublast/DrawnUi.Maui.Camera) control brought features like real-time video and audio processing. We will talk about video frames processing in the next article, meanwhile let’s have some fun with the audio stream: we can work in audio-only monitoring mode.
