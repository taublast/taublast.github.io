...
Add the following [file `Contents.json`](https://github.com/DrawnUi/DrawnUi.Net.Breakout/blob/main/src/Platforms/iOS/Assets.xcassets/icon.appiconset/Contents.json) too along with your images, this file defines the icon set metadata. 
...
In case you would want to see a published working example of .NET MAUI app with such native icons please check out the [Breakout repo](https://github.com/DrawnUi/DrawnUi.Net.Breakout).
