...
The MAUI-Rust template opens the door to some very practical uses:
...
Would love to see what you build with this pattern. Also please feel to contribute to the repo, especially if you want to cover the Linux case.

While this could be a convinient way to integrate Rust code into .NET MAUI apps, I am sure an even more seamless way would emerge due to .NET community efforts. 
