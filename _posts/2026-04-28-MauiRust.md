...
description: "How to wire Rust into a .NET MAUI app so Cargo builds with F5, native code stays in one solution, and new Rust exports can now be bound automatically."
