...
The tools used to make this app formed a stand-alone open-source library, [DrawnUI for .NET MAUI](https://github.com/DrawnUi/DrawnUi.Net.Maui), consumable as a nuget or a source code dependency.
...
<video controls muted autoplay playsinline>
  <source src="https://github.com/DrawnUi/DrawnUi.Net.Maui/assets/25801194/3b360229-ce3b-4d33-a85b-554d1cca8408" type="video/mp4">
...
Many examples are inside the [Sandbox](https://github.com/DrawnUi/DrawnUi.Net.Maui/tree/main/src/samples/Sandbox) project as well as in the [demo apps](https://github.com/taublast).
...
There are a lot of drawn controls inside the [Sandbox](https://github.com/DrawnUi/DrawnUi.Net.Maui/tree/main/src/samples/Sandbox) project inside the DrawnUI repository:
...
Here is [one of the examples](https://github.com/DrawnUi/DrawnUi.Net.Maui.Demo/tree/main/src/Usual) of embedding drawn controls into a usual MAUI layout, drawn controls `SkiaLabel` and `SkiaMarkdownLabel` in action, with HotReaload: 
...
### [DrawnUI Demo](https://github.com/DrawnUi/DrawnUi.Net.Maui.Demo)

<div class="video-container-github">
<video controls muted autoplay playsinline>
  <source src="https://github.com/DrawnUi/DrawnUi.Net.Maui.Demo/assets/25801194/092833ea-ef96-4fda-b4e6-3b706cbab79e" type="video/mp4">
  Your browser does not support the video tag.
</video>
</div>
...
Would you have any specific technical questions about using DrawnUI please feel free to use [Discussions](https://github.com/DrawnUi/DrawnUi.Net.Maui/discussions).

The [DrawnUI for .NET MAUI](https://github.com/DrawnUi/DrawnUi.Net.Maui) repository contains most of the reference links used in this article.  
