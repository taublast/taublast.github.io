...
image:
  path: /assets/img/ceojuly.jpg
  lqip: /assets/img/ceojuly.jpg
---
...
Here is [one of the examples](https://github.com/taublast/DrawnUi.Maui.Demo/tree/main/src/Usual) of embeeding drawn controls into a usual MAUI layout, drawn controls `SkiaLabel` and `SkiaMarkdownLabel` in action, with HotReaload: 
